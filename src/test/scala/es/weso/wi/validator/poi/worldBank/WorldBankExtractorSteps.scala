...
class ValidateWorldBankSteps extends ScalaDsl with EN with ShouldMatchers {
  
    
  Given("""^I want to check the WorldBank indicator "([^"]*)" for "([^"]*)" in "([^"]*)"$""") { (indicator: String, region: String, year: String) =>
